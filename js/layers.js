...
addLayer("sc",{
    ...
    gainMult() { // Calculate the multiplier for main currency from bonuses
        ...
        if (player.sc.pointsGain.gte(0.01) || player.sc.p1 == true) {player.sc.points = player.sc.points.add(1);player.sc.p1 = true } else {player.sc.p1 = false}
        if (player.i.inGain.div(player.p.b11eff).gte(1) || player.sc.i1 == true) {player.sc.points = player.sc.points.add(1);player.sc.i1 = true} else {player.sc.i1 = false}
        if (player.i.inGain.div(player.p.b11eff).gte(1024) || player.sc.i2 == true) {player.sc.points = player.sc.points.add(1);player.sc.i2 = true} else {player.sc.i2 = false}
        if (player.sc.debuff2.gte(64) || player.sc.d1 == true) { player.sc.points = player.sc.points.add(1);player.sc.d1 = true} else {player.sc.d1 = false}
        return new ExpantaNum(1)
    },
    tabFormat: [
        "main-display",
